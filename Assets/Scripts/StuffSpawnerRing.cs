...
public class StuffSpawnerRing : MonoBehaviour {
    ...
    public Material[] spawnerMaterials;
    ...
    void CreateSpawner(int index)
    {
        ...
        rotater.localRotation = Quaternion.Euler(0f, 360f / numberOfSpawners * index, 0f);
        ...
        spawner.stuffMaterial = spawnerMaterials[index % spawnerMaterials.Length];
    }
}
